...
CATEGORY_KEYWORDS: dict[str, list[str]] = {
    "Food": [
        ...
        "RESTAURANT", "FOOD", "CAFE", "HOTEL", "HOSPITALITY", "BIRYANI",
        "KITCHEN", "DHABA", "BAKERY", "SWEET", "JUICE", "CHAI",
    ],
    "Groceries": [
        "BIGBASKET", "BLINKIT", "ZEPTO", "DMART", "GROFERS", "JIOMART",
        "GROCERY", "SUPERMARKET", "RELIANCE FRESH", "MORE RETAIL",
        "NATURE'S BASKET", "STAR BAZAAR",
    ],
    "Shopping": [
        "AMAZON", "FLIPKART", "MYNTRA", "AJIO", "NYKAA", "MEESHO",
        "SNAPDEAL", "SHOPCLUES", "TATA CLIQ", "RELIANCE",
    ],
    "Transport": [
        "OLA", "UBER", "RAPIDO", "METRO", "IRCTC", "RAILWAY",
        "REDBUS", "IXIGO", "MAKEMYTRIP", "GOIBIBO", "CLEARTRIP",
    ],
    "Fuel": [
    ...
    "Investment": [
        "MUTUAL FUND", "MF", "PRUDENT", "ZERODHA", "GROWW", "UPSTOX",
        "KUVERA", "SIP", "COIN", "DEMAT", "CAMS", "KARVY",
    ],
    "Insurance": [
        "LIC", "INSURANCE", "PREMIUM", "POLICY", "ICICI LOMBARD",
        "HDFC ERGO", "STAR HEALTH", "MAX LIFE",
    ],
    "Utilities": [
        "ELECTRICITY", "WATER", "GAS", "TORRENT", "ADANI", "BESCOM",
        "MSEDCL", "BILL", "BROADBAND", "WIFI", "INTERNET",
    ],
    "Recharge": [
        "RECHARGE", "JIO", "AIRTEL", "VI ", "VODAFONE", "BSNL",
        "PREPAID", "POSTPAID", "MOBILE",
    ],
    "Entertainment": [
        "NETFLIX", "HOTSTAR", "PRIME VIDEO", "SPOTIFY", "YOUTUBE",
        "BOOKMYSHOW", "PVR", "INOX", "MOVIE", "GAME",
    ],
    "Medical": [
        "PHARMACY", "MEDICAL", "HOSPITAL", "DOCTOR", "APOLLO",
        "MEDPLUS", "1MG", "PHARMEASY", "NETMEDS", "CLINIC",
    ],
    "Education": [
    ...
    "ATM Withdrawal": [
        "ATM", "CASH WDL", "ATM WDL",
    ],
    "Charges": [
        "CHARGES", "SMS CHRG", "MIN BAL CHRG", "SERVICE CHARGE",
        "ANNUAL FEE", "MAINTENANCE",
    ],
    "Interest": [
        "INTEREST", "INT.PAID", "INT CREDIT",
    ],
    "Government": [
        "TAX", "GST", "INCOME TAX", "TDS", "GOVT", "STAMP DUTY",
        "CHALLAN", "MCA", "EPFO", "PF",
    ],
}
